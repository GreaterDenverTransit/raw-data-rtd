...
def find_and_process_files(directory, column_order, output_file):
    """
    Find files ending with 'calendar_dates.txt', reorder columns, and concatenate them.
    ...
    for root, _, files in os.walk(directory):
        for file in files:
            if file.endswith("calendar_dates.txt"):
...
outfile = 'Combined_gtfs\gtfs_all_calendar_dates.csv'
